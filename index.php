                                    ...
                                    <form class="main_form">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <input class="form-control" placeholder="Name" type="text" name="Name" required onkeypress="return chr(event);">
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <input class="form-control" placeholder="Email" type="text" name="Email" required>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                <input class="form-control" placeholder="Phone" type="text" name="Phone" required onkeypress="return numb(event);">
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">

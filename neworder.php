...
<body class="main-layout">
  ...
  <input class="form-control" placeholder="Customer name" type="text" name="customer_name" required onkeypress="return chr(event);">
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                           <input class="form-control" placeholder="phone" type="text" name="cus_phone" required>
                                            </div>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">                   <input class="form-control" placeholder="Eamil" type="text" name="email" required onKeyPress="return numb(event);">
                                            </div>
                                          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                   <textarea class="textarea" placeholder="Message" type="text" name="address"></textarea>
                                            </div>
